...
if(!message.channel.guild) return;
    ...
    var client;
      if(mentionned){
        ...
        .setColor(000000)
        .setFooter(Bot Special, 'ur bot image link')
...
client.on("message", message => {
 ...
 message.delete(); 
    ...
    if (message.content.startsWith("ترحيب")) {
     ...
     .setImage('https://cdn.discordapp.com/attachments/568955377668849674/571141976720932875/Welcome_To_Tokyo_Shop.png')
